...
open class UART
{
	...
	public struct UUID
	{
		...
		/// 通知キャラスティックUUID
//		public static var notify						:String = "6e400002-b5a3-f393-e0a9-e50e24dcca9e"
...
//				self.deviceDelegate.delegates["\(#file)"] = newValue
			} else {
...
//			return self.deviceDelegate.delegates["\(#file)"]
		}
	}
}
